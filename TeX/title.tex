...
\newcommand{\titlos}{Προκαταρτικός Και Ηλεκτρολογικός Σχεδιασμός Ημιαυτόνομου Ρομποτικού Διασώστη Για U.S.A.R. Αποστολές}
...
\newcommand{\advisor}{Γιαννάκης Ευστράτιος}
...
\begin{titlepage}
    ...
    \vspace{3em}
    \includegraphics[width=0.3\textwidth]{media/lmemdlogo.png}
    \end{center}
